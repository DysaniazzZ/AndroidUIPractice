...
public class Practice02StaticLayoutView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        // 使用 StaticLayout 代替 Canvas.drawText() 来绘制文字，以绘制出带有换行的文字
        canvas.save();
        ...
        StaticLayout staticLayout = new StaticLayout(text, textPaint, (int) width, Layout.Alignment.ALIGN_NORMAL, 1, 0, true);
